...
<body>
    <div class="form-container">
        ...
        <div class="nav-links">
            <a href="/SiiA/gestion_evenements/views/events/list_events.php">View Events</a>
            <a href="/SiiA/gestion_evenements/views/inscriptions/list_inscriptions.php">View Registrations</a>
        </div>
    </div>
